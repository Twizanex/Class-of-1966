  ...
  <?php /* Our navigation menu.  If one isn't filled out, wp_nav_menu falls back to wp_page_menu. The menu assiged to the primary position is the one used. If none is assigned, the menu with the lowest ID is used. */ ?>
          ...
          <a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="no-margin" rel="home" title="The First Timeline WordPress Theme"><img class="logo" src="<?php if(get_option('tl_logo_header')!=""){echo get_option('tl_logo_header');}else{echo get_bloginfo('stylesheet_directory')."/images/logo.png";} ?>"></a>
            ...
            <div class="timeline-scroll-bar">
                ...
                FROM ".$table_prefix."posts WHERE post_type='post' and post_status='publish' order by date_format(post_date,'%Y/%m')desc";
...
<header id="branding" role="banner">
			...
			<div id="cover-video">
				<embed type="application/x-shockwave-flash" src="http://www.youtube.com/v/<?php echo get_option("tl_cover_video");?>?version=3&hl=it_IT?rel=0&showinfo=0&autoplay=0&showsearch=0&iv_load_policy=3&ampautohide=1" width="950" height="533" style="" id="mymovie" name="mymovie" quality="high" wmode="opaque"/>
			</div>
			<script type="text/javascript" src="http://www.magnificaweb.it/flashobject/swfobject.js"/>
			<script type="text/javascript">
				var so = new SWFObject("http://www.youtube.com/v/<?php echo get_option("tl_cover_video");?>?version=3&amp;hl=it_IT?rel=0&amp;showinfo=0&amp;autoplay=0&amp;showsearch=0&amp;iv_load_policy=3&ampautohide=1", "mymovie", "950", "533", "7", "");
				so.addParam("wmode", "opaque");
				so.write("cover-video");
			</script>
			<?php } ?>
